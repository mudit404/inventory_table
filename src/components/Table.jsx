...
export default function InventoryManagement() {
    ...
    //     { id: 1, name: 'Product 1', price: 29.99, category: 'Electronics', quantity: 10 },
    //     { id: 2, name: 'Product 2', price: 49.99, category: 'Clothing', quantity: 5 },
    //     { id: 3, name: 'Product 3', price: 19.99, category: 'Books', quantity: 0 },
    // ];
...
// export default function InventoryManagement() {
//     const initialProducts = [
//         { id: 1, name: 'Product 1', price: 29.99, category: 'Electronics', inventoryStatus: 'INSTOCK', quantity: 10 },
//         { id: 2, name: 'Product 2', price: 49.99, category: 'Clothing', inventoryStatus: 'LOWSTOCK', quantity: 5 },
//         { id: 3, name: 'Product 3', price: 19.99, category: 'Books', inventoryStatus: 'OUTOFSTOCK', quantity: 0 },
//     ];
...
//         <div className="flex justify-content-between">
//             <div>
//                 <InputText type="search" onInput={(e) => setGlobalFilter(e.target.value)} placeholder="Search by category..." />
//             </div>
//             <Button label="Add Product" icon="pi pi-plus" onClick={openNewProductDialog} />
//         </div>
//     );
...
//     return (
//         <div className="card">
//             <DataTable value={products} paginator rows={10} header={header} footer={footer} globalFilter={globalFilter} 
//                 tableStyle={{ minWidth: '60rem' }}>
//                 <Column field="name" header="Name" sortable></Column>
...
//                     <Button label="Save" icon="pi pi-check" onClick={saveProduct} className="p-button-text" />
//                 </>} 
//                 onHide={hideDialog}>
//                 <div className="field">
